...
function Cart() {
  ...
  const handleCouponPercent = () => {
    switch (couponCode.toUpperCase()) {
      case "GAURAV@10": setCouponCodePercent(10); break;
      case "GAURAV@20": setCouponCodePercent(20); break;
      case "GAURAV@30": setCouponCodePercent(30); break;
      case "GAURAV@40": setCouponCodePercent(40); break;
